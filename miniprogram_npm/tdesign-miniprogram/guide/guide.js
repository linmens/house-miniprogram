  ...
  constructor() {
    ...
    this.methods = {
      init() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
          ...
          if (modeType === 'popover') {
            ...
            // const rect = rectViewport[0]
            // const view = rectViewport[1]
            // console.log(rect, view, 'srect')
            // const {
            //   scrollTop
            // } = view
            // // 步骤条展示的高度需要加上屏幕滚动的高度
            // rect.top += view.scrollTop;
            // // 根据实际情况需要滚动到展示区域
            // wx.pageScrollTo({
            //   scrollTop: rect.top,
            //   duration: 100,
      ...
      buttonProps(step, mode) {
        ...
        skipButton = Object.assign(Object.assign({
          theme: 'light',
          content: '跳过',
          size
        }, skipButton), {
          class: `${prefix}-class-skip ${name}__button ${step.hideSkip ? `${name}__button--hidden` : ''} ${(skipButton === null || skipButton === void 0 ? void 0 : skipButton.class) || ''}`,
          type: 'skip'
        });
        let nextButton = (_b = step.nextButtonProps) !== null && _b !== void 0 ? _b : this.data.nextButtonProps;
        nextButton = Object.assign(Object.assign({
          theme: 'primary',
          content: '下一步',
          size
        }, nextButton), {
          class: `${prefix}-class-next ${name}__button ${(nextButton === null || nextButton === void 0 ? void 0 : nextButton.class) || ''}`,
          type: 'next'
        });
        nextButton = Object.assign(Object.assign({}, nextButton), {
          content: this.buttonContent(nextButton)
        });
        let backButton = (_c = step.backButtonProps) !== null && _c !== void 0 ? _c : this.data.backButtonProps;
        backButton = Object.assign(Object.assign({
          theme: 'light',
          content: '返回',
          size
        }, backButton), {
          class: `${prefix}-class-back ${name}__button ${(backButton === null || backButton === void 0 ? void 0 : backButton.class) || ''}`,
          type: 'back'
        });
        let finishButton = (_d = step.finishButtonProps) !== null && _d !== void 0 ? _d : this.data.finishButtonProps;
        finishButton = Object.assign(Object.assign({
          theme: 'primary',
          content: '完成',
          size
        }, finishButton), {
          class: `${prefix}-class-finish ${name}__button ${(finishButton === null || finishButton === void 0 ? void 0 : finishButton.class) || ''}`,
          type: 'finish'
        });
        finishButton = Object.assign(Object.assign({}, finishButton), {
          content: this.buttonContent(finishButton)
        });
        return {
          skipButton,
          nextButton,
      ...
      onTplButtonTap(e) {
        ...
        switch (type) {
          case 'next':
            this.triggerEvent('next-step-click', Object.assign({
