 ...
 export const newerBehavior = Behavior({
   ...
   methods: {
     ...
     calcNewer() {
       ...
       let total = NP.plus(this.data.buyer.qishui, houseBookPrice, paymentPrice, loanPrice, loanGjjPrice, floorPrice)
       let withoutTotal = NP.plus(this.data.buyer.qishui, paymentPrice, houseBookPrice, floorPrice)
       this.setData({
