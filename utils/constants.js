...
export const loanGjjHomeTypes = [{
  ...
  desc: '借款人单人连续足额缴存住房公积金的，贷款额度最高不超过65万;'
}, {
  value: 2,
  ...
  desc: '借款人及配偶同时连续足额缴存住房公积金的，贷款额度最高不超过85万。'
}, {
  value: 3,
  label: '多子女家庭',
  max: {
  ...
  desc: '2024年5月9日起，多子女家庭(抚养至少有一个未成年子女的二孩及以上家庭)使用公积金贷款购买住房的，贷款最高额度在现行信贷政策基础上提高至1.2倍，即78万。'
}, {
  value: 4,
  label: '双缴存职工多子女家庭',
  max: {
...
export const NoticeData = {
  ...
  hukouwuye: `在二手房交易过程中，物业交割保证金和户口迁出保证金是常见的保障措施，旨在确保交易的顺利进行并保护买卖双方的利益。
